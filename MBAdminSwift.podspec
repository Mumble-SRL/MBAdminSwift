#
#  Be sure to run `pod spec lint MBAdmin.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/Mumble-SRL/MBAdminSwift.git", :tag => "1.0.11" }
  ...
  spec.source_files  = "MBAdminSwift/*.{h,m,swift}", "MBAdminSwift/**/*.{h,m,swift}"
